...
public class LarryQuest{
	...
	public void larrysQuest(){
		...
		if(p.getItemInHand().hasItemMeta()){
			if(p.getItemInHand().getItemMeta().getDisplayName().equals("Red Mushroom")){
				...
				//if(dg.checkInProgress(13,p)&&!dg.checkCompleted(13,p)){p.sendMessage(ChatColor.DARK_GREEN+"Larry: "+ChatColor.GREEN+"Having trouble?");}
					...
					if(dg.checkCompleted(13,p)){p.sendMessage(ChatColor.DARK_GREEN+"Larry: "+ChatColor.GREEN+"Thank you! Those mushrooms were perfect!");}
				}
			}
		}
		else
		{
			...
			{
				if(dg.checkInProgress(13,p)&&!dg.checkCompleted(13,p)){p.sendMessage(ChatColor.DARK_GREEN+"Larry: "+ChatColor.GREEN+"Having trouble?");}
				else{if(dg.checkCompleted(13,p)){p.sendMessage(ChatColor.DARK_GREEN+"Larry: "+ChatColor.GREEN+"Thank you! Those mushrooms were perfect!");}}
			}
		}
	}
}