	...
	public void wizardsQuest(){
		...
		if(p.getItemInHand().hasItemMeta()){
			if(p.getItemInHand().getItemMeta().getDisplayName().equals("Magma ball")){
				...
				//if(dg.checkInProgress(17,p)&&!dg.checkCompleted(17,p)){p.sendMessage(ChatColor.DARK_GREEN+"Reiner: "+ChatColor.GREEN+"Do you have my Leather?");}
					...
					if(dg.checkCompleted(17,p)){p.sendMessage(ChatColor.DARK_GREEN+"Wizard: "+ChatColor.GREEN+"My spell worked! Hope you are using the Book and Quill I gave you. Helps keep track of your life.");}
				}
			}
		}
		else
		{
			if(!dg.checkInProgress(17,p)&&(!dg.checkCompleted(17,p)))
			{
				...
				if(dg.checkInProgress(17,p)&&!dg.checkCompleted(17,p)){p.sendMessage(ChatColor.DARK_GREEN+"Wizard: "+ChatColor.GREEN+"I asked you for 10 Magma balls.");}
				else{if(dg.checkCompleted(17,p)){p.sendMessage(ChatColor.DARK_GREEN+"Wizard: "+ChatColor.GREEN+"My spell worked! Hope you are using the Book and Quill I gave you. Helps keep track of your life.");}}
			}
		}
	}
}